  ...
  return (
    <div className="relative pb-24 scroll-smooth">
      ...
      <div className="flex items-center justify-between gap-4 mb-6 md:mt-0 relative z-20">
        <Link 
          href="/archive"
          className="flex items-center gap-2 text-[var(--color-text-secondary)] hover:text-[var(--color-text-main)] transition-colors bg-[var(--color-surface)] hover:bg-[var(--color-surface-hover)] px-3 sm:px-4 py-2 rounded-xl border border-[var(--color-border)] text-xs font-medium uppercase tracking-widest"
        >
          <ArrowLeft size={16} /> 
      ...
      <div className="mt-20 relative z-10 animate-[fade-up_0.6s_ease-out_both]">
        <div className="flex flex-col items-center justify-center text-center mb-16 relative">
          ...
          <div className="bg-[var(--background)] px-6 relative z-10">
            ...
            <h2 className="text-2xl font-bold text-[var(--color-text-main)] uppercase tracking-[0.3em]">Comprehensive Data Sheets</h2>
            <p className="text-sm text-[var(--color-text-muted)] mt-2 font-light tracking-widest uppercase">Deep dive metrics for all active lines</p>
          </div>
        </div>
