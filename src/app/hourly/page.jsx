...
export default function HourlyPage() {
  ...
  if (loading && !data) {
    return (
      <div className="flex-1 p-4 md:p-8 flex items-center justify-center min-h-[50vh]">
        <div className="flex flex-col items-center gap-4">
          <RefreshCw className="w-8 h-8 text-[var(--color-primary)] animate-spin" />
          <p className="text-[var(--color-text-secondary)] font-medium uppercase tracking-widest text-sm">Loading Hourly Data...</p>
        </div>
      </div>
    );
  }
