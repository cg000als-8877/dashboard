  ...
  return (
    <div className="space-y-8 animate-[fade-up_0.4s_ease-out_both]">
      <header className="mb-10 relative z-10">
        ...
        <p className="text-[var(--color-primary)] font-bold tracking-widest uppercase text-xs mt-2">Deep dive into financial and production metrics.</p>
      </header>
      ...
      <Card className="relative overflow-hidden">
        ...
        <h3 className="text-xs md:text-sm font-black text-[var(--color-text-secondary)] uppercase tracking-widest mb-6 border-b border-[var(--color-border)] pb-3">Production Metrics Breakdown</h3>
        <p className="text-sm font-medium text-[var(--color-text-muted)] leading-relaxed max-w-3xl">
