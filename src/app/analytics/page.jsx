  ...
  return (
    <div className="space-y-8 animate-[fade-up_0.4s_ease-out_both]">
      ...
      <Card className="relative overflow-hidden">
        ...
        <h3 className="text-xs md:text-sm font-black text-gray-400 uppercase tracking-widest mb-6 border-b border-[rgba(255,255,255,0.05)] pb-3">Production Metrics Breakdown</h3>
