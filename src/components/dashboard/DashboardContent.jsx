...
export function DashboardContent({ month, isArchive = false }) {
  ...
  if (error) {
    return <div className="text-red-500 text-center mt-20 font-bold bg-[rgba(255,0,0,0.1)] p-4 rounded-xl border border-red-500/20">Error loading data: {error}</div>;
  }
